...
export default function WebBeforeAfter({ data }) {
  return (
    <section className="section-padding section-dark-gradient relative overflow-hidden">
      ...
      <Container className="relative z-10 max-w-4xl">
        <AnimatedText className="text-center mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl heading-on-dark mt-3 mb-4">Dijital Vitrininizi Yenileyin</h2>
          <p className="text-body-on-dark text-sm md:text-base">
            Aynı otel konsepti — eski standart web sitesi ile modern rezervasyon odaklı tasarım karşılaştırması. Konsept görsel.
          </p>
        </AnimatedText>
        <BeforeAfterComparison
          beforeImage={data.before.image}
          afterImage={data.after.image}
          beforeLabel="Eski / Standart"
          afterLabel="Modern Tasarım"
