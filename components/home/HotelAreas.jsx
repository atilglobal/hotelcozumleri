            ...
            <AnimatePresence mode="wait">
              {selected ? (
                ...
                >
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-navy mt-2 mb-6">Bu Alandaki Çözümlerimiz</h3>
                  <ul className="space-y-3">
                    {selected.solutions.map((solution) => (
                      <li key={solution} className="flex items-center gap-3 py-2 border-b border-navy/8">
                        <span className="w-2 h-2 rounded-full bg-gold shrink-0" />
                        <span className="text-navy font-medium">{solution}</span>
                      </li>
                    ))}
                  </ul>
                </motion.div>
                ...
                <motion.div key="default" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-navy mb-4">Bir alan seçin</h3>
                  <p className="text-body-on-light leading-relaxed max-w-md">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          activeArea === area.id
                            ...
                            : "bg-off-white border-navy/8 text-navy hover:border-gold/40"
                        )}
                      >
                        {area.name}
                      </button>
