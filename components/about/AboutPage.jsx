...
const sections = [
...

  {
    ...
    body: "Tekstil, temizlik, SPA sarf, kapı sistemleri, yapay bitki dekorasyonu ve ekipman ihtiyaçlarınız için tedarikçi ağımızdan fiyat toplar, size özel teklif sunarız. Katalog satışı değil — talep bazlı profesyonel satın alma modeli.",
...
const sectionVariants = ["section-dark-a", "section-dark-b", "section-dark-c", "section-dark-d", "section-dark-gradient"];

const backdropVariants = ["a", "b", "c", "d", "gradient"];
    ...
    <>
      ...
      {sections.map((section, index) => (
        ...
        <section
          ...
          className={cn("section-padding relative overflow-hidden", sectionVariants[index % sectionVariants.length])}

        >

          <SectionBackdrop variant={backdropVariants[index % backdropVariants.length]} />
          ...
          <Container className="relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <AnimatedText className={index % 2 === 1 ? "lg:order-2" : ""}>
                ...
                <span className="text-gold-light text-xs font-bold tracking-[0.2em] uppercase">{section.eyebrow}</span>

                <h2 className="text-3xl md:text-4xl font-bold heading-on-dark mt-3 mb-5 leading-tight">{section.title}</h2>

                <p className="text-body-on-dark text-base md:text-lg leading-relaxed">{section.body}</p>

              </AnimatedText>

              <div className={cn("relative aspect-[4/3] rounded-2xl overflow-hidden glass-card-dark", index % 2 === 1 ? "lg:order-1" : "")}>
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-5xl md:text-6xl font-extrabold text-white/10">{String(index + 1).padStart(2, "0")}</p>

                    <p className="text-sm font-semibold heading-on-dark mt-2">{section.eyebrow}</p>
      ...
      <section className="section-padding section-dark-b relative overflow-hidden">
        ...
        <SectionBackdrop variant="b" watermark="HOTELIO" />
        ...
        <Container className="relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="p-8 rounded-2xl glass-card-dark">
      ...
      <section className="py-16 section-dark-c relative overflow-hidden">
        ...
        <Container className="relative z-10 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl font-bold heading-on-dark mb-4">Birlikte Çalışalım</h2>

          <p className="text-body-on-dark mb-8">Teknoloji, tedarik veya dijital dönüşüm için ekibimizle görüşün.</p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">

            <Button href="/teklif-al" variant="gold" size="lg">Teklif Al</Button>

            <Button href="/tedarik" variant="secondary-glass" size="lg">Tedarik Talebi</Button>
